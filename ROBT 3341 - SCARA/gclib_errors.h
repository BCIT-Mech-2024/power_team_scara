...
#define G_TIMEOUT -1100 //!< Operation timed out. Timeout is set by the --timeout option in GOpen() and can be overriden by GTimeout().
...
#define G_ALREADY_OPEN -1111 //!< Serial or PCI file has a flock placed on it, presumably by another gclib connection.
